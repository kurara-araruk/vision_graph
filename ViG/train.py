...
# fit関数の定義
def fit(net, optimizer, criterion, num_epochs, train_loader, test_loader, device, history, scheduler=None, save_dir='log', save_name='output.log'):
...
train_set = datasets.CIFAR10(
    root = "/scr/data/CIFAR10",  train = True,
...
num_epochs = 10
history = fit(net, optimizer, criterion, num_epochs, train_loader, val_loader, device, history, scheduler, log_dir)
